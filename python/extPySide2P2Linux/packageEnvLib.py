...
# DESCRIPTION
# ----------------------------------------------------------------------------------------------------
## @file    extPySide2P2Linux/packageEnvLib.py @brief [ FILE   ] - Package environment module.
## @package extPySide2P2Linux.packageEnvLib    @brief [ MODULE ] - Package environment module.
